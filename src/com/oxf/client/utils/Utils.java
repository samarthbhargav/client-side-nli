...
public class Utils
{
    ...
    {
        StringBuilder builder = new StringBuilder();
        builder.append( "<div id=\"result-div\" class=\"result-div\" style=\" padding: 3% \" >" );
        ...
        for ( ResultClass c : classes ) {
            if(countStudentsWithClass( students, c ) > 0) {
                builder.append( "Number of Students who scored " + c + " : " + countStudentsWithClass( students, c )
                + ". <br/>" );
            }
        }
        builder.append( "</div>" );
